...
public class TeleStats {
	...
	public TeleStats(int numberExonicAlignments, int number3UTRAlignments, int numberUnsplicedAlignments, int[] baseCoverage, ArrayList<String>[] baseCoverageNames) {
	...
	public double fractionUTRCounts(){
		return (double)(1+number3UTRAlignments) / (double)(1+numberExonicAlignments);
	}
