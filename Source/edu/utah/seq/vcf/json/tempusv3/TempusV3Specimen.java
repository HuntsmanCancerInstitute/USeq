...
public class TempusV3Specimen {
	...
	public void addMetaData(LinkedHashMap<String, String> meta, int id) {
		...
		if (primarySampleSite != null) meta.put("tempusPrimarySampleSite_"+id, primarySampleSite);
		...
		if (tempusIcdOCodeMorphology != null) meta.put("tempusIcdOCodeMorphology_"+id, tempusIcdOCodeMorphology);
		if (tempusIcdOCodeTopography != null) meta.put("tempusIcdOCodeTopography_"+id, tempusIcdOCodeTopography);
		if (tempusIcd10Code != null) meta.put("tempusIcd10Code_"+id, tempusIcd10Code);
		if (originPathLabDiagnosis != null) meta.put("originPathLabDiagnosis_"+id, originPathLabDiagnosis);
	}
	...
	public static void addAttributes(LinkedHashMap<String, String> reportAttributes, TempusV3Specimen[] specimens) {
		...
		reportAttributes.put("matchedNormal", normalFound.toString());
