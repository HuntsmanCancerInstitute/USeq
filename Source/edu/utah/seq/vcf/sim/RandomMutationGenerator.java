...
public class RandomMutationGenerator {
	...
	private int maxIndelSize = 7;
	private double allelicRatio = 0.5;

	public RandomMutationGenerator (String[] args){
		...
		try {
			...
			if (regions.length <= (numberSNVs+numberINDELs)) Misc.printErrAndExit("\nError: More mutations requested than number of regions? Aborting!\n");
			...
			for (int i=0; i< numberINDELs; i++) mutateINDEL(regions[i]);
	...
	public static void main(String[] args) {
		...
		new RandomMutationGenerator(args);
	}
	...
	public static void printDocs(){
		System.out.println("\n" +
				"**************************************************************************************\n" +
				"**                        Random Mutation Generator  : June 2014                    **\n" +
				"**************************************************************************************\n" +
				"Adds random SNVs and INDELs to fasta files. Saves the mutant sequences and a vcf file\n" +
				"of the changes. Run the SamMutationConverer app to modfiy alignments to match the\n"+
				"reference sequence.\n\n" +

				"Required:\n"+
				"-r Full path bed file containing regions in which to create mutations. See Sam2USeq.\n"+
				"-s Number of SNVs to make.\n\n"+
				"-i Number of INDELs to make. This plus -s shouldn't exceed the number of regions.\n\n"+

				"Optional:\n" +
				"-m Max indel size, defaults to 7\n"+
